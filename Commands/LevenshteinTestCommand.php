...
use Test\LevenshteinEditDistanceTest;

class LevenshteinTestCommand extends Command
{
    // the name of the command (the part after "bin/console")
    protected static $defaultName = 'LevenshteinTest';
    ...
    $output->writeln('///////// Levenshtein Test /////////');
    $Levenshtein = new LevenshteinEditDistanceTest;
    $Levenshtein->start(
    ...
    $output->writeln('============');
    foreach ($Levenshtein->result as $value) {
